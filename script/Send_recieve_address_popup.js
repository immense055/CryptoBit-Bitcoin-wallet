...
function NetworkToUse(network) {
    ...
    document.getElementById('btn_receive_btc').addEventListener('click', function () {
    ...
    chrome.storage.sync.get('addr', (x) => {
        ...
        con.open('GET', 'https://chart.googleapis.com/chart?cht=qr&chs=150x150&chl=' + x.addr[0].address);
        con.send();
    ...
    document.getElementById('close_popup_btc_receive').addEventListener('click', function () {
        var popup_receive_btc = document.getElementById('popup_receive_btc');
    ...
    document.getElementById('btn_address_btc').addEventListener('click', function () {
...
console.log('xxx')
        ...
        chrome.storage.sync.get('addr', (x) => {
            ...
            for (var i = 0; i < x.addr.length; i++) {
                ...
                btc_adr_list.innerHTML += "<div class='adr_list_btc_cont'><span class='btc_adr_span'>" + x.addr[i].address + "</span>" +
    ...
    document.getElementById('close_popup_btc_address').addEventListener('click', function () {
        var popup_address_btc = document.getElementById('popup_address_btc');
    ...
    document.getElementById('btn_send_ether').addEventListener('click', function () {
    ...
    document.getElementById('btn_receive_ether').addEventListener('click', function () {
    ...
    document.getElementById('btn_address_ether').addEventListener('click', function () {
        var popup_addresses_ether = document.getElementById('popup_addresses_ether');
    ...
    document.getElementById('close_popup_ether').addEventListener('click', function () {
        var popup_send_ether = document.getElementById('popup_send_ether');
    ...
    document.getElementById('close_popup_ether_receive').addEventListener('click', function () {
        var popup_receive_ether = document.getElementById('popup_receive_ether');
    ...
    document.getElementById('close_popup_ether_addresses').addEventListener('click', function () {
        var popup_addresses_ether = document.getElementById('popup_addresses_ether');
    ...
    document.getElementById('copu_btc_addres').addEventListener('click', function () {
