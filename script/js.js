...
function NetworkToUse(network) {
  ...
  window.onload = function() {
    ...
    document
      .getElementsByClassName("open_b_wal")[0]
      .addEventListener("click", x => {
        var bd = document.getElementById("open_bd_wal");
        if ((bd.classList.contains = "animate_hiding")) {
          bd.classList.remove("animate_hiding");
        }
    ...
    document
      .getElementsByClassName("open_e_wal")[0]
      .addEventListener("click", x => {
        var ed = document.getElementById("open_ed_wal");
        if ((ed.classList.contains = "animate_hiding")) {
          ed.classList.remove("animate_hiding");
        }
    ...
    document
      .getElementsByClassName("wallet_balance")[0]
      .addEventListener("click", x => {
