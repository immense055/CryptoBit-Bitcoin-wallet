...
document
  .getElementById("settings_icon_id_page")
  .addEventListener("click", firstFoox54644, false);
//Show popup settings
function firstFoox54644(xxx) {
  ...
  chrome.storage.sync.get(["email", "btc_wallet_name"], res => {
    ...
    console.log(res.btc_wallet_name);
    ...
    if (res.email) {
      ...
      btnLogOut.onclick = () => {
        ...
        document.getElementById("loggedInfo").innerHTML =
          "<div class='card__face card__face--front'><h2 class='headingset'>User Autentication</h2>" +
        ...
        function foo1(event) {
          ...
          if (checkBtnPress === "inpId1") {
            if (document.getElementById("Headingloginorregister") != null) {
              document.getElementById("Headingloginorregister").innerHTML =
                "Login";
            }
        ...
        crEl.method = 'POST';*/
         ...
         everethungels.appendChild(div1)*/
            ...
            var sendLogintoServer1 = document.getElementById(
              "sendLogintoServer"
            );
        ...
        crEl.method = 'POST';*/
            ...
            everethungels.appendChild(crEl);
            var sendLogintoServer = document.getElementById(
              "sendLogintoServerUP"
            );
            ...
            if (resp) {
              ...
              getLogOutAddress1.onload = () => {
                ...
                chrome.storage.sync.set(
                  { originData: { wallet: completed, addrOrigin: resp } },
                  calB => {
