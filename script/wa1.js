...
function NetworkToUse(network) {
  ...
  var ttt45gfdg = "";
  document
    .getElementById("add_new_bit_addr")
    .addEventListener("click", function() {
      x343hgh();
    });

  document
    .getElementById("addnewAddress_btc")
    .addEventListener("click", x343hgh);
  ...
  function x343hgh() {
    ...
    chrome.storage.sync.get("addr", x => {
      if (x.addr.length >= 5) {
        ...
        credivpop.innerHTML =
          '<span class="w1">Warning</span><span class="wcl2">Please use addresses that you already have!</span><button id="closebtnwarn">Ok</button>';
        ...
        con2.onreadystatechange = function() {
          if (this.readyState == 4) {
            ...
            document.getElementById("btc_addres_list").innerHTML +=
              "<div class='adr_list_btc_cont'><span class='btc_adr_span'>" +
              newAddress.address +
              "</span><i class='fas fa-info-circle infoCalssstyle'></i></div>";
            ...
            function infoClick(x) {
              ...
              xhr.onreadystatechange = function() {
                if (this.readyState == 4) {
                  ...
                  var txnameNumnerTx = document.getElementById(
                    "txnameNumnerTx"
                  );
                  var txnametotalrec = document.getElementById(
                    "txnametotalrec"
                  );
                  var txnametotalsent = document.getElementById(
                    "txnametotalsent"
                  );
                  ...
                  txnameBal.innerHTML =
                    final_balance.balance / 100000000 + " BTC";
              ...
              chrome.storage.sync.get("addr", z => {
                ...
                con9.onreadystatechange = function() {
                  if (this.readyState == 4 && this.status == 200) {
                    ...
                    document
                      .getElementById("qr_code_img")
                      .setAttribute("src", qr_source);
                  }
                };
        ...
        con2.open(
          "POST",
          "https://api.blockcypher.com/v1/" + network + "/addrs"
        );
        con2.send();
      }
    });
