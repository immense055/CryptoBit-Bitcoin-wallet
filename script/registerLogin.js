...
function f3() {
    ...
    if (validateEmail(inputEmail.value) === true && inputPassword.value.length > 0) {
                ...
                chrome.storage.sync.get(null, (res) => {
                    ...
                    chrome.storage.sync.set({
                        ...
                        chrome.storage.sync.get(['email', 'btc_wallet_name'], (res) => {
                            ...
                            document.getElementById('logiudIdbtn9093').addEventListener('click', FuckingFoo)
    ...
    function focus1(event) {
        ...
        if (event.currentTarget.id === 'inputEmail') {
            if (document.getElementById('everethungels').contains(document.getElementById('emailcheckUP'))) {
                document.getElementById('everethungels').removeChild(document.getElementById('emailcheckUP'))
            }
        } else if (event.currentTarget.id === 'inputPassword') {
            if (document.getElementById('everethungels').contains(document.getElementById('passcheckUP'))) {
                document.getElementById('everethungels').removeChild(document.getElementById('passcheckUP'))
            }
    ...
    function incorrectEmail() {
        ...
        if (everethungels.contains(document.getElementById('emailcheckUP'))) {} else {
    ...
    function incorrectPassword() {
        ...
        if (everethungels.contains(document.getElementById('passcheckUP'))) {} else {
...
function ff3() {
    ...
    //Send to Server
    if (validateEmail(inputEmail.value) === true && inputPassword.value.length > 0 && inputPassword.value === inputPasswordyy2.value) {
...
function FuckingFoo() {
    ...
    document.getElementById('loggedInfo').innerHTML = "<div class='card__face card__face--front'><h2 class='headingset'>User Autentication</h2><img src='images/gui/verification.svg' class='UserAutenticationIMAGE' alt='User Autentication'><div class='inputCOntcla'>" +
