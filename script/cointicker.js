...
*/
            ...
            function fillEthInput() {
                document.getElementById('pay_in_eth').addEventListener('keyup', function (x) {
                ...
                document.getElementById('pay_in_usd_eth').addEventListener('keyup', function (x) {
            ...
            function fillBtcInput() {
                document.getElementById('pay_in_btc').addEventListener('input', function (x) {
                ...
                document.getElementById('pay_in_usd').addEventListener('input', function (x) {
            ...
            */
            ...
            var bit_arrow = (priceticker.data[1].quotes.USD.percent_change_1h >= 0) ? true : false;
            var ether_arrow = (priceticker.data[1027].quotes.USD.percent_change_1h >= 0) ? true : false;
